                                          ...
                                          <div class="tab_style2">
                                             <div class="tabbar">
                                                <nav>
                                                   ...
                                                   <a class="nav-item nav-link active show" id="nav-contact-tab" data-toggle="tab" href="#profile_section" role="tab" aria-selected="false">Profile</a>
                                                      <a class="nav-item nav-link" id="nav-home-tab" data-toggle="tab" href="#recent_activity" role="tab" aria-selected="true">Recent Activity</a>
                                                ...
                                                <div class="tab-content" id="nav-tabContent">
                                                   <div class="tab-pane fade" id="recent_activity" role="tabpanel" aria-labelledby="nav-home-tab">
                                                      <div class="msg_list_main">
                                                         <ul class="msg_list">
                                                            @foreach ($quizTimings as $quizTiming)
                                                            <li>
                                                               <span><img src="images/layout_img/msg2.png" class="img-responsive" alt="#"></span>
                                                               <span>
                                                               <span class="name_user">Attended <b>{{$quizTiming->quiz->title}}</b></span>
                                                               <span class="msg_user">{{$quizTiming->quiz->description}}</span>
                                                               <span class="time_ago" data-bs-toggle="tooltip" data-bs-placement="top" title="{{date('d-m-Y h:i:s A',strtotime($quizTiming->start_time))}}">{{$quizTiming->quiz->started_on}}</span>
                                                               </span>
                                                            </li>
                                                            @endforeach
